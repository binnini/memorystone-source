...
턴 진행은 동기 함수 방식입니다. 진입점을 한 번 부르면 그 페이즈의 규칙과 턴 경계 16단계가 끝까지 실행되고, 순서는 함수 안의 줄 순서 한 곳에만 적혀 있습니다. 이것은 1절에서 연출을 연산 결과로부터 파생시키기로 한 구조의 귀결입니다. 연산이 한 번에 끝나야 결과 기록이 완성되고, 그 기록에서 연출이 만들어지기 때문입니다.
